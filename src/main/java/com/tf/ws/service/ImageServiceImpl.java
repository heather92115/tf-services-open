...
import com.tf.ws.repositories.LargePhotoRepository;
import com.tf.ws.repositories.MediumPhotoRepository;
import com.tf.ws.repositories.PhotoRepository;
...
public class ImageServiceImpl implements ImageService, Serializable {
	...
	{
		return mediumPhotoRepository.getMediumPhotoById(mediumPhotoId);
	}
	 ...
	 *
	 * @param sourcePhotoContent    Original image content in form of byte array.
